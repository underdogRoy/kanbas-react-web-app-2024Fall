...
export default function Modules() {
  ...
  const updateModule = (module: any) => {
    ...
    return (
            ...
            <div><ProtectedContent roles={['FACULTY']}>
            <ModulesControls setModuleName={setModuleName} moduleName={moduleName} addModule={() => {
          dispatch(addModule({ name: moduleName, course: cid }));
          setModuleName("");
             }} /></ProtectedContent><br /><br /><br /><br />
          ...
          <li className="wd-module list-group-item p-0 mb-5 fs-5 border-gray">
            ...
            <ProtectedContent roles={['FACULTY']}><BsGripVertical className="me-2 fs-3" /> {!module.editing && module.name}
      { module.editing && (
 ...
 <ProtectedContent roles={['FACULTY']}><ModuleControlButtons moduleId={module._id}
